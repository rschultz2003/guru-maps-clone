...
- README.md and PLAN.md match the Guru Maps–inspired App Store feature set (offline OSM, custom pins/icons, folders, routes, tracks/GPX, offline search, 3D terrain, sync, CarPlay, no ads, privacy-first).
